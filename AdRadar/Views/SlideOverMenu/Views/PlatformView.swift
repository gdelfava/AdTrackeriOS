...
struct PlatformDateFilterSheet: View {
    ...
    private var quickFilters: [PlatformDateFilter] {
        [.today, .yesterday]
    }
    
    private var periodFilters: [PlatformDateFilter] {
        [.last7Days, .thisMonth, .lastMonth]
    }
    
    private var extendedFilters: [PlatformDateFilter] {
        [.lifetime]
    }
        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    PlatformFilterSection(title: "Quick Access") {
                        VStack(spacing: 0) {
                    ...
                    PlatformFilterSection(title: "Time Periods") {
                        VStack(spacing: 0) {
                    ...
                    PlatformFilterSection(title: "Extended Range") {
                        VStack(spacing: 0) {
    ...
    private func selectFilter(_ filter: PlatformDateFilter) {
        // Haptic feedback
...
struct PlatformFilterSection<Content: View>: View {
    let title: String
    let content: Content
...
struct PlatformFilterRow: View {
    let filter: PlatformDateFilter
    let isSelected: Bool
    let action: () -> Void
